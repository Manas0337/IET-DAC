...
namespace _25Demo_GenericDelegate
{
    ...
    public delegate R FunctionDelegate<T, R>(T para);
    ...
    internal class Program
    {
        static void Main(String[] args)
        {
            ...
            //del4("Anandi", "The movie was really good!!");
            ...
            //math.Test<string, string, string, string>(del1Greet, "manas pawar", "Good Morning");
        }
    }
    public class Demo
    {
